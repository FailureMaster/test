                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form--control checkUser" name="firstname" value="{{ old('firstname') }}" required placeholder="@lang('Your firstname')" autocomplete="off">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form--control checkUser" name="lastname" value="{{ old('lastname') }}" required placeholder="@lang('Your lastname')" autocomplete="off">
                                        <small class="text--danger"></small>
                                    </div>
                                </div>
                                <div class="col-md-12">
