    ...
    function fetchOrderHistory() {
        ...
        $.ajax({
            ...
            success: function(resp) {
                ...
                document.querySelector("#free-margin-span").innerText = `${formatWithPrecision1(free_margin + bonus + credit)} USD`;
                
                equity_span.html(`${formatWithPrecision1(equity + bonus + credit)} USD`);
